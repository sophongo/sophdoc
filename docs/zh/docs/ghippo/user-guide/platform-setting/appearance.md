...
在算丰 AI 算力平台中，可通过 __外观定制__ 更换登录界面、顶部导航栏以及底部版权和备案信息，帮助用户更好地辨识产品。

## 定制说明

1. 使用具有 __admin__ 角色的用户登录 AI AI 算力平台。点击左侧导航栏底部的 __全局管理__ -> __平台设置__ 。
...
!!! note
    ...
    如果想要恢复默认设置，可以点击 __一键还原__ 。请注意，一键还原后将丢弃所有自定义设置。
